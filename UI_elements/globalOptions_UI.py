...
Item("whichTime2", show_label = False, editor=RangeEditor(mode='slider', low_name = 'includeEmptySpace',  high_name='ts2max'), visible_when = 'radioButton2 == "Y" and clamp == 0', width = sliderw),
...
Item("FRTxt", style = 'readonly', show_label = False, height = smallh, width = -70),
Item("framerate", show_label = False, height = tinyh, width = tinyw),
Item("SaveImgTxt", style = 'readonly', show_label = False, height = smallh, width = -80),
Item("save_images", show_label = False, height = tinyh, width = tinyw),
