...
isoUIelements = (Group(
	...
	HGroup(Item("ThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s):'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(Item("ThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s) %:'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("changeThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Change threshold with time:'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("finalThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold:'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold1 == True'),
	...
	Item("finalThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold %:'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold1 == True'),
	...
	Item("finalTimeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final time:'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold1 == True'),
	...
	Item("changeThresholdTypeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Type:'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold1 == True'),
	...
	HGroup(
	Item("colorFieldsTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Color field:'), visible_when='radioButton1 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(Item("ThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s):'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(Item("ThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s) %:'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("changeThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Change threshold with time:'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("finalThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold:'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold2 == True'),
	...
	Item("finalThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold %:'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold2 == True'),
	...
	Item("finalTimeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final time:'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold2 == True'),
	...
	Item("changeThresholdTypeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Type:'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold2 == True'),
	...
	HGroup(
	Item("colorFieldsTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Color field:'), visible_when='radioButton2 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(Item("ThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s):'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(Item("ThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s) %:'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("changeThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Change threshold with time:'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("finalThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold:'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold3 == True'),
	...
	Item("finalThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold %:'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold3 == True'),
	...
	Item("finalTimeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final time:'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold3 == True'),
	...
	Item("changeThresholdTypeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Type:'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold3 == True'),
	...
	HGroup(
	Item("colorFieldsTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Color field:'), visible_when='radioButton3 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(Item("ThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s):'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(Item("ThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Threshold(s) %:'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("changeThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Change threshold with time:'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
	...
	HGroup(
	Item("finalThresholdTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold:'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold4 == True'),
	...
	Item("finalThresholdPercentTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final threshold %:'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold4 == True'),
	...
	Item("finalTimeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Final time:'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold4 == True'),
	...
	Item("changeThresholdTypeTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Type:'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization" and changeThreshold4 == True'),
	...
	HGroup(
	Item("colorFieldsTxt", style = 'readonly', show_label = False, height = smallh, width = determine_width('Color field:'), visible_when='radioButton4 == "Y" and allLocalOptions == "Isosurface" and allModeOptions == "Visualization"'),
