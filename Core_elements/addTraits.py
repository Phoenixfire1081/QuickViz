...
def include_all_traits(self):
	...
	self.on_trait_change(self.allPlaygroundOptionsActualChanged, "numGridPoints_playground")
	self.on_trait_change(self.allPlaygroundOptionsActualChanged, "a_playground")
	self.on_trait_change(self.allPlaygroundOptionsActualChanged, "b_playground")
	self.on_trait_change(self.allPlaygroundOptionsActualChanged, "visualizeGrid_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "allPredefinedVortices")
	self.on_trait_change(self.allPredefinedVorticesChanged, "rotAxisX_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "rotAxisY_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "rotAxisZ_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "rotationAngle_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "translatex_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "translatey_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "translatez_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "ringRadius_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "thickness_playground")
	self.on_trait_change(self.allPredefinedVorticesChanged, "allPredefinedKnots")
	self.on_trait_change(self.allPredefinedVorticesChanged, "p_torus")
	self.on_trait_change(self.allPredefinedVorticesChanged, "q_torus")
